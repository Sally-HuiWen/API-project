...
// Sends a JWT Cookie
// my note: this is a function that sets the JWT cookie after a user is logged in or signed up.It is NOT a middleware
...
const restoreUser = (req, res, next) => {
    ...
    return jwt.verify(token, secret, null, async (err, jwtPayload) => {
      if (err) {//my note: not match!not verified
        return next();
      }
      //my note: 
      try {
